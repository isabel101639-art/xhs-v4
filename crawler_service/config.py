...
class CrawlerSettings:
    ...
    xhs_search_related_query_selector: str
...
def get_settings():
    return CrawlerSettings(
        ...
        xhs_search_url_template=(
            os.environ.get('XHS_SEARCH_URL_TEMPLATE')
            or 'https://www.xiaohongshu.com/search_result?keyword={keyword}&source=web_explore_feed'
        ).strip(),
        ...
        xhs_post_author_selector=(os.environ.get('XHS_POST_AUTHOR_SELECTOR') or '').strip(),
        ...
        xhs_search_related_query_selector=(os.environ.get('XHS_SEARCH_RELATED_QUERY_SELECTOR') or '').strip(),
