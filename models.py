...
class Submission(db.Model):
    ...
    selected_title = db.Column(db.String(200))
    selected_title_source = db.Column(db.String(100))
    selected_title_index = db.Column(db.Integer, default=0)
    selected_copy_version_index = db.Column(db.Integer, default=0)
    selected_copy_goal = db.Column(db.String(50))
    selected_copy_skill = db.Column(db.String(50))
    selected_title_skill = db.Column(db.String(50))
    selected_image_skill = db.Column(db.String(50))
    selected_cover_style_type = db.Column(db.String(50))
    selected_inner_style_type = db.Column(db.String(50))
    selected_generation_mode = db.Column(db.String(50))
    selected_copy_text = db.Column(db.Text)
    strategy_payload = db.Column(db.Text)
    strategy_updated_at = db.Column(db.DateTime)
...
class AssetGenerationTask(db.Model):
    ...
    draft_source_type = db.Column(db.String(20))
    draft_source_id = db.Column(db.Integer)
    draft_plan_id = db.Column(db.Integer)
    source_provider = db.Column(db.String(50), default='svg_fallback')
    model_name = db.Column(db.String(100))
    style_preset = db.Column(db.String(50), default='小红书图文')
    generation_mode = db.Column(db.String(50), default='smart_bundle')
    cover_style_type = db.Column(db.String(50))
    inner_style_type = db.Column(db.String(50))
...
class AssetPlanDraft(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    source_type = db.Column(db.String(20), default='trend')
    source_id = db.Column(db.Integer)
    source_title = db.Column(db.String(200))
    bucket_label = db.Column(db.String(100))
    template_agent_label = db.Column(db.String(100))
    image_skill_label = db.Column(db.String(100))
...
class CorpusEntry(db.Model):
    ...
    template_type_key = db.Column(db.String(50))
    tags = db.Column(db.String(300))
...
class HotTopicEntry(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    reference_note_id = db.Column(db.Integer)
    title = db.Column(db.String(300), nullable=False)
    keyword = db.Column(db.String(200))
    source_platform = db.Column(db.String(50), default='小红书')
    source_channel = db.Column(db.String(50), default='热点转热搜话题')
    reference_url = db.Column(db.String(500))
    summary = db.Column(db.Text)
    hot_score = db.Column(db.Integer, default=0)
    lane_key = db.Column(db.String(50))
    persona_key = db.Column(db.String(50))
    audience_hint = db.Column(db.String(300))
    integration_hint = db.Column(db.Text)
    usage_tip = db.Column(db.Text)
    status = db.Column(db.String(20), default='active')
    created_at = db.Column(db.DateTime, default=datetime.now)
    updated_at = db.Column(db.DateTime, default=datetime.now, onupdate=datetime.now)
...
class LiverIpProfilePlan(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    profile_key = db.Column(db.String(64), unique=True, nullable=False)
    background_key = db.Column(db.String(50))
    preferred_lane_key = db.Column(db.String(50))
    goal_key = db.Column(db.String(50))
    weekly_cadence = db.Column(db.String(50))
    profile_note = db.Column(db.Text)
    plan_payload = db.Column(db.Text)
    generator_seed_payload = db.Column(db.Text)
